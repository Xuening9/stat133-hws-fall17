...
plot(dat1$EFF, dat1$Salary,ylab = "Salary", xlab = "Efficiency", cex = 0.7, col = "grey", main = "scatterplot with lowess smooth")
lines(lowess(dat1$EFF,dat1$Salary,), lwd = 2.5, col = "red")
```
